...
In CitasMedicasAPS-labels_en.properties:
CitasMedicasAPS=My application
CitasMedicasAPS[description]=My application does this and that

In CitasMedicasAPS-messages_en.properties:
